...
slug: product-vision
topic: product
summary: Olas is a private-first photo-feed-first client for small communities, pivoted away from NIP-29 group features (to be added later) toward a pictures-feed-first
tags:
  - capture
volatility: warm
confidence: medium
