...
// Search feed management and account creation stay in Rust.
...
/// nmp_app_create_new_account with empty initial relays. Default relay setup is
/// owned by olas_app_register.
#[no_mangle]
